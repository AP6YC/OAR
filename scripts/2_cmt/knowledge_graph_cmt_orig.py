...
# import os
# os.chdir('/Users/danielhier/desktop/cmt')
...
gene = ''
proteins = set()
df = pd.read_csv(data_dir("CMT_Location_Disease_Gene.csv"), header=0)
# df= pd.read_csv("CMT_Location_Disease_Gene.csv", header=0)
...
# Open a file in write mode
# with open('edge_attributes.txt', 'w') as file:
with open(results_dir('edge_attributes.txt'), 'w') as file:

...
class_names= ['Cluster 1', 'Cluster 2', 'Cluster 3', 'Cluster 4', 'Cluster 5', 'Cluster 6', 'Cluster 7', 'Cluster 8', 'Cluster 9']
shap.summary_plot(shap_values, X, plot_type='bar', feature_names=feature_names, class_names  = class_names, max_display = 12, plot_size = float (0.5))
model = xgboost.XGBRegressor().fit(X, y)
